...
# If _exchange_id() treated "ccxt" as a venue, every reconcile query would resolve
# getattr(ccxt, "ccxt") -> None and silently fail. These pin that "ccxt"/empty collapse
# to the okx default (or the HERMX_CCXT_EXCHANGE override).
# ---------------------------------------------------------------------------
